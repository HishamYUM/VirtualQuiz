...
public class DummyPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("here");System.out.println("here");System.out.println("here");


        final DatabaseHandler2 databaseHandler = new DatabaseHandler2(this);
        List<Questions> listData = null;// get questions from database
        try {
            listData = databaseHandler.getAllData();
        } catch (IOException e) {
            e.printStackTrace();
        }
